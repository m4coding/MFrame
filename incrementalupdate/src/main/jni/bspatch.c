//
// Created by mochangsheng on 2017/3/11.
//
//修改bspatch.c将main函数重命名为doPatch函数
...
JNIEXPORT jint JNICALL Java_com_mcs_incrementalupdate_BsPatch_doPatch(
