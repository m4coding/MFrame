...
public class TagFlowLayout extends FlowLayout implements TagAdapter.OnDataChangedListener
{
    ...
    private boolean mItemOnlySelect = false;//checked之后，再次点击不会取消checked状态
    ...
    public TagFlowLayout(Context context, AttributeSet attrs, int defStyle)
    {
        ...
        mItemOnlySelect = ta.getBoolean(R.styleable.TagFlowLayout_only_select_effect, false);
        ta.recycle();
...
//            lp.rightMargin = clp.rightMargin;
    ...
    private void doSelect(TagView child, int position)
    {
        if (mAutoSelectEffect)
        {
            ...
            {
                if (mItemOnlySelect) {//当被check之后，再次点击此item，不会被取消checked
                    return;
                }
